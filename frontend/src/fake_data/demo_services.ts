...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the iHOS App service.", fields: {} },
    restart: { description: "Restart the iHOS App service.", fields: {} },
    check_config: {
      description:
        "Check the iHOS App configuration files for errors. Errors will be displayed in the iHOS App log.",
      fields: {},
    },
    update_entity: {
