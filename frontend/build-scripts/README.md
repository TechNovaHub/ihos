# Bundling iHOS App Frontend

The iHOS App build pipeline contains various steps to prepare a build.
...
Currently in iHOS App we use a bundler to convert TypeScript, CSS and JSON files to JavaScript files that the browser understands.
